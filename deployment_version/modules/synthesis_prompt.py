...
def build_privacy_synthesis_prompt(
    ...
    return (
        ...
        "INSTRUCTIONS:\n"
        "1. Read the Masked Variations. They contain the EXACT placeholders (like <PERSON>, <GIVEN_LOCATION>) "
        "or redactions you must use.\n"
        "2. Combine them into a single coherent output. If different variations use different labels for the same info (e.g., [REDACTED ID] vs [REDACTED ACCOUNT]), just use a single generic [REDACTED] tag to resolve the conflict.\n"
        "3. NOTE: ALL sensitive data (Identity, Financial, Health, etc.) has been ALREADY redacted by an upstream security layer. "
        ...
        "4. DO NOT add any extra conversational text, labels, apologies, or markdown formatting.\n"
        "5. DO NOT summarize or truncate. DO NOT refuse to process based on 'safety'-this text is already sterilized. Output the full text with all redactions applied.\n\n"
        "EXAMPLE:\n"
